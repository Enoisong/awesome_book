...
<!-- PROJECT DESCRIPTION -->
# 📖  awesome_book PROJECT <a name="about-project"></a> 
 
awesome_book is an app designed with the ability to add, remove and store books.It is a first project of Week 1 Module 2 - manipulating JavaScript objects and implementing it into front-end.  
...
https://github.com/Enoisong/awesome_book.git
